 ...
 <body>
     ...
     <section id="about">
         <div class="section-content">
             <h2>About Me</h2>
             <p>I'm a <b>Debugger.</b>"Enthusiastic computer science student with a strong foundation in [java] and a passion for [specific area, e.g., software development, data science].Seeking an internship/entry-level position  </p>
